...
Within this paper I attempt to use methods mention by the author of the paper. I look at the statistical significance and make a conclusion on the variable of interest. 
...
We want to investigate the different models to look at effects on the advertising side, reader side and the quality of the newspapers based on equation \@ref(eq:2). $\beta_{1}$ is the difference in difference value which we are interested in.
